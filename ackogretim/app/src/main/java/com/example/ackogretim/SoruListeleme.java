...
public class SoruListeleme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sinavid = intent.getStringExtra("sinavid");
        ...
        listeAdapter = new ListeAdapter(SoruListeleme.this ,sorular); //listeadapter sınıfından yeni nesne oluşturduk sorular dizisini kullanarak olusturdugumuz adaptere set ettik.
        ...
        arama.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                (SoruListeleme.this).listeAdapter.getFilter().filter(s);
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(getApplicationContext(), soruislemler.class);
