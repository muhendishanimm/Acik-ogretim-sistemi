...
public class sinavsorulistesi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listeAdapter = new ListeAdapter(sinavsorulistesi.this ,sorular); //listeadapter sınıfından yeni nesne oluşturduk sorular dizisini kullanarak olusturdugumuz adaptere set ettik.
