...
public class ogrencianasayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int ogrid = intent.getIntExtra("ogrid",1);
        ...
        mQueue.add(request);
        onlineSinavAdapter = new OnlineSinavAdapter(ogrencianasayfa.this,sinavlar);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                Intent intent = new Intent(getApplicationContext(), ogrencisinavbilgileri.class);
